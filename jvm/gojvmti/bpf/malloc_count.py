#!/usr/bin/python
#
#dr1:/s1/bpf# /usr/share/bcc/tools/funccount c:malloc
#Tracing 1 functions for "c:malloc"... Hit Ctrl-C to end.
#^C
#FUNC                                    COUNT
#malloc                                  26896
#Detaching...
#dr1:/s1/bpf# /usr/share/bcc/tools/funccount c:free
#Tracing 1 functions for "c:free"... Hit Ctrl-C to end.
#^C
#FUNC                                    COUNT
#free                                    23975
#Detaching...
...
###########
print("Tracing malloc for 10s ... Ctrl-C to end")
